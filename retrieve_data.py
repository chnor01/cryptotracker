...
def save_coins_id(data):
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS coinsxdd (id VARCHAR(255) PRIMARY KEY, symbol VARCHAR(255), name VARCHAR(255))")
    ...
    for coin in data:
        ...
        sql = """
            INSERT INTO coinsxdd (id, symbol, name) VALUES (%s, %s, %s) 
...
def save_coins_prices(data):
    ...
    for coin_id, details in data.items():
        ...
        last_updated_at = datetime.fromtimestamp(unix_time)
